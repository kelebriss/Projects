...
volatile int IBI = 550;             // int that holds the time interval between beats! Must be seeded!
...
void loop(){
  ...
  // -------------------------------- Hall effect ------------------------------------
     ...
     timeold = millis();
     half_revolutions = 0;
     speedvalue = w_lenght *rpm
     c=Serial.println(speedvalue,DEC); // speed calculate
   }
  //--------------------------------- bluetooth-----------------------------------------
